...
urlpatterns = [
    ...
    path('faculty/<int:faculty_id>/assign-subject/', views.assign_subject_to_faculty, name='assign_subject_to_faculty'),
    path('faculty/<int:faculty_id>/unassign-subject/', views.unassign_subject_from_faculty, name='unassign_subject_from_faculty'),
